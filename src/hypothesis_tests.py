...
def test_gender_risk(df):
    ...
    group_a = local_df[local_df['Gender'].str.upper() ==
                       'FEMALE']['Margin'].dropna()
    group_b = local_df[local_df['Gender'].str.upper() ==
                       'MALE']['Margin'].dropna()
...
def test_security_impact(df):
    ...
    group_a = claims_subset[claims_subset['TrackingDevice']
                            == 0]['TotalClaims'].dropna()
    group_b = claims_subset[claims_subset['TrackingDevice']
                            == 1]['TotalClaims'].dropna()
